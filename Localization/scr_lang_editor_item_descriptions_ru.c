...
lang_gui_name[lang_num,1] = "Жёлтые Кристаллы"
...
lang_gui_desc[lang_num,179] = "Водные кубы! Идеальны для того, чтобы разлить воду где нужно, игнорируя глобальный уровень воды на локации, а так же в местах, где ты не мог разлитьводу до этого!"
lang_gui_name[lang_num,180] = "Мячи Для Бассейна"
lang_gui_desc[lang_num,180] = "Разноцветные мячи, которые отскакивают от стен и игрока! В отличии от баскетболььных мячей, Эти могут лежать друг на друге!"
...
lang_gui_desc[lang_num,187] = "Эй! Ваш босс звонит! Встречайте - Сэвви Мэриголд, директора проэкта по расширению академии Шанг Му. When she's not training staff or managing the managers, Savvy is hard at work in the field herself! Does she ever sleep?"
