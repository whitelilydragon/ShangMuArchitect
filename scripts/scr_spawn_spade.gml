...
obj_game_logic.skin = spr_spade
obj_game_logic.bike = 0
obj_game_logic.lives_spr = 7
obj_game_logic.petals = 14
obj_game_logic.petalsmax = 14
obj_game_logic.hud_graphics = spr_hud_spa
obj_game_logic.my_pal_sprite = spr_spade_palette
obj_game_logic.ui_pal_sprite = spr_spade_palette
obj_game_logic.breath_modifier = 0.00200
obj_game_logic.snd_player_hurt_0 = spade_hurt_1      //Hurt Sound 1
obj_game_logic.snd_player_hurt_1 = spade_hurt_2      //Hurt Sound 2
obj_game_logic.snd_player_death  = spade_death       //Death Sound
obj_game_logic.push_sound = spade_push
obj_game_logic.swimming_frame = obj_game_logic.anim_spade[obj_game_logic.anim_swimming,0]
//Physics Parameters
